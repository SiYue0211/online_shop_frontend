                    ...
                    >
                      ...
                      <div style="padding: 14px;">
                        <el-row>
                          ...
                          <el-col :span="12">
                            <el-tag v-if="scope.row.images.defaultImg == 1">
                              <input
                                type="radio"
                                checked
...
export default {
  ...
  watch: {
    uploadImages (val) {
      // 扩展每个skus里面的imgs选项
      console.log("UploadImages Before: ", this.spu.images)
      let imgArr = Array.from(new Set(this.spu.images.concat(val)))
      console.log("UploadImages After: ", imgArr)
      ...
      console.log("spu images after upload: ", this.spu.images)
